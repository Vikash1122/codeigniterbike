        ...
        <div class="content-wrapper">        
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Ongoing Orders                                    
        ...
        ajax();             
              ...
              $('#order_list').html('');             
                $.ajax({
                    ...
                    data:{'user_id':user.user_id,'page':page,'perpage':perpage,'status':'ongoing','rent_type':rent_type,'order_id':order_id,'daterange':daterange},
                    method:'get',
                    ...
                    if(($.trim(res.data.length))!==0){ 
                     $.each(res.data, function( key, value ) {
                        $('#order_list').append('<tr> <td>ord_00'+value.order_id+' </td><td> <p class="mb-2">'+value.bike_name+'</p><p class="mb-0 text-muted text-small">'+value.engine+'</p>  </td><td>'+value.user_name+'</td><td>'+value.start_date+'</td><td style="color:red;">Waiting For Update</td><td>'+value.duration+'</td><td>'+value.rent_type+'</td><td>'+value.price+'</td><td> <div class="template-demo"> <a class="btn btn-primary btn-sm" href="ongoingOrderDetails?order_id='+value.order_id+'">View</a></i></button> </div></td></tr>');
                          });
