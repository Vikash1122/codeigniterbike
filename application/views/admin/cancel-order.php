        ...
        <div class="content-wrapper">        
            <div class="row">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Cancel Orders                                    
         ...
         function ajax(page=1,perpage=10,rent_type='',order_id='',daterange=''){       
              ...
              $('#order_list').html('');             
                $.ajax({
                    ...
                    data:{'user_id':user.user_id,'page':page,'perpage':perpage,'status':'cancel','rent_type':rent_type,'order_id':order_id,'daterange':daterange},
                    method:'get',
                    ...
                    if(($.trim(res.data.length))!==0){ 
                     $.each(res.data, function( key, value ) {
                        $('#order_list').append('<tr> <td>cord_00'+value.order_id+' </td><td> <p class="mb-2">'+value.bike_name+'</p><p class="mb-0 text-muted text-small">'+value.engine+'</p>  </td><td>'+value.user_name+'</td><td>'+value.booking_date+'</td><td >'+value.cancel_date+'</td><td >'+value.reason+'</td><td>'+value.rent_type+'</td><td> <div class="template-demo"> <a class="btn btn-primary btn-sm" href="cancelOrderDetails?order_id='+value.order_id+'">View</a> </div></td></tr>');
                          });
