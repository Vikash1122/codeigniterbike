...
$this->db->set('seen','true')->where('create_at>=CURDATE()')->update('bike_rented');
}}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">        
            <div class="row">
                            ...
                            <form class="forms-sample">
                                <div class="row">
                                    ...
                                    <label>By Date</label>     
                                        ...
                                        <input type="text" class="form-control" name="daterange" id="daterange" placeholder="">
                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Active Orders                              
            ...
            alert("You are " + years + " years old!");
              ...
              $('#order_list').html('');             
                $.ajax({
                    ...
                    data:{'user_id':user.user_id,'page':page,'perpage':perpage,'status':'active','rent_type':rent_type,'order_id':order_id,'daterange':daterange},
                    method:'get',
                    ...
                    if(($.trim(res.data.length))!==0){ 
                     $.each(res.data, function( key, value ) {
                        $('#order_list').append('<tr> <td>ord_00'+value.order_id+' </td><td> <p class="mb-2">'+value.bike_name+'</p><p class="mb-0 text-muted text-small">'+value.engine+'</p>  </td><td>'+value.user_name+'</td><td>'+value.activate_at+'</td><td>'+value.rent_type+'</td><td> <div class="template-demo"> <a class="btn btn-primary btn-sm" href="activeOrderDetails?order_id='+value.order_id+'">View</a>  </div></td></tr>');    
                          });
